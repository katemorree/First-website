/* =========================================================
   SAMEO SMASH — the hero burger, in nine pieces
   ---------------------------------------------------------
   ...
   Seven pictures, nine layers: the cheese arrived as one
   image of two separate slices, and the patties as one image
   of two that touch. Both were parted in the build script.

   That is the whole trick. Because all nine files share a
...
/* The shared canvas the nine layers were composed on. Only used for the
...
export const BURGER_LAYERS = [
  ...
  { slug: 'pattybot', name: 'lower smashed patty' },
  { slug: 'cheesebot', name: 'lower cheese slice' },
  { slug: 'pattytop', name: 'upper smashed patty' },
